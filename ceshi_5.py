...
from duotupian import Ui_Form as Ui_Page3
from shipin import Ui_Form as Ui_Page4
from shexiangtou import Ui_Form as Ui_Page5
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.a = 0
        self.model_path = "weights/hongwaiout.pt"#hongwaiout.pt,best.pt
    ...
    def open_mp4(self):
        ...
        if fileName:
            self.model_path = "weights/best.pt"  # hongwaiout.pt,best.pt
            self.model = self.model_load(weights=self.model_path)
