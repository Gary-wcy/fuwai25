...
################################################################################
## Form generated from reading UI file 'shipin.ui'
##
...
"}")
        ...
        self.label_2.setPixmap(QPixmap(u"images/resources/\u76f8\u673a.png"))
        ...
        self.widget.setGeometry(QRect(351, 221, 761, 552))
        self.verticalLayout = QVBoxLayout(self.widget)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.pictures_img = QLabel(self.widget)
...
"}")
        ...
        self.up_load_button_2 = QPushButton(self.widget)
...
"QPushButton{margin:5px 5px}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_7.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:28pt; font-weight:700;\">\u89c6<br/>\u9891<br/>\u68c0<br/>\u6d4b</span></p></body></html>", None))
