...
from tupian_2 import Ui_Form as Ui_Page6 #融合仅作展示
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.page6.setupUi(self.widget_page6)
        ...
        self.stacked_widget.addWidget(self.widget_page6)
        ...
        self.page6.backbutton.clicked.connect(self.go_to_page1)
    ...
    def go_to_page1(self):
        ...
        self.page2.img_label.setText("\n等待检测")
        self.page3.imgs_label.setText("\n等待检测")
        self.page4.vid_label.setText("\n等待检测")
        self.page5.vid_label.setText("\n等待检测")
    ...
    def bind(self):
        ...
        self.page2.show_button.clicked.connect(self.go_to_page6)
        #多图片
        ...
        #多模态展示页面
        self.page6.up_load_button.clicked.connect(self.pic1)
        self.page6.start_button.clicked.connect(self.pic2)
    ...
    def detect_img(self):
        ...
        im0 = cv2.resize(im0, (0, 0), fx=resize_scale, fy=resize_scale)
        cv2.imwrite("images/tmp/pic3.jpg", im0)
        self.page2.right_img.setPixmap(QPixmap("images/tmp/pic3.jpg"))
    ...
    def enhance_image(self, image_path):
        ...
        enhanced_image_path = os.path.join("images/tmp", f"enhanced_imgs.jpg")
    ...
    def pic1(self):#仅作实际内容展示
        fileName, fileType = QFileDialog.getOpenFileName(self, 'Choose file', '', '*.jpg *.png *.tif *.jpeg')
        if fileName:
            self.page6.left_img.setPixmap(QPixmap("images/resources/pic1.png"))
            fileName1, fileType1 = QFileDialog.getOpenFileName(self, 'Choose file', '', '*.jpg *.png *.tif *.jpeg')
            if fileName1:
                self.page6.left_img_2.setPixmap(QPixmap("images/resources/pic.jpg"))
                self.page6.right_img.setPixmap(QPixmap(IMAGE_RIGHT_INIT))

    def pic2(self):#仅作实际内容展示
        loop = QEventLoop()
        QTimer.singleShot(200, loop.quit)
        loop.exec()
        self.page6.right_img.setPixmap(QPixmap("images/tmp/pic2.jpg"))
        loop = QEventLoop()
        QTimer.singleShot(300, loop.quit)
        loop.exec()
        self.page6.right_img_2.setPixmap(QPixmap("images/tmp/pic3.png"))
